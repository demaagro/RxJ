...
#[derive(Debug)]
pub struct RxJSReactiveProcessor {
    verbose: bool,
    processed_count: usize,
}

impl RxJSReactiveProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting RxJSReactive processing");
    
    let mut processor = RxJSReactiveProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = RxJSReactiveProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = RxJSReactiveProcessor::new(false);
